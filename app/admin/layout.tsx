...
export default function AdminLayout({
  ...
  return (
    <div className="min-h-screen bg-gray-900">
      {/* 侧边栏 */}
      <div className={`fixed inset-y-0 left-0 z-40 w-64 bg-gray-800 transform ${sidebarOpen ? 'translate-x-0' : '-translate-x-full'} transition-transform duration-300 ease-in-out lg:translate-x-0 lg:static lg:inset-0`}>
          ...
          <div className="flex items-center justify-between h-16 px-4">
            ...
            <div className="flex-1 flex justify-between">
              ...
              <div className="flex items-center">
                <button className="ml-4 flex text-sm rounded-full focus:outline-none">
