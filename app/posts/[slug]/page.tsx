...
TypeScript 提供了强大的类型系统，让 JavaScript 开发更加安全和高效。
...
type Result2 = Check<number>; // 'not string'
\`\`\`
...
TypeScript 的高级特性可以帮助我们构建更类型安全、更可维护的应用程序。
    `,
...
Tailwind CSS 是一个实用优先的 CSS 框架，提供了丰富的工具类来快速构建现代化的用户界面。
...
Tailwind CSS 提供了强大的工具类系统，让开发者能够快速构建美观的用户界面。
    `,
